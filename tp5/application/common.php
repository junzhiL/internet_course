...
if (!function_exists('alert_success')) {
    function alert_success($msg='',$url='',$time=2){
        $str='<script type="text/javascript" src="/static/assets/js/vendor/jquery-2.1.4.min.js"></script> <script type="text/javascript" src="/static/assets/layer/layer.js"></script>';//加载jquery和layer
        $str.='<script>
        $(function(){
